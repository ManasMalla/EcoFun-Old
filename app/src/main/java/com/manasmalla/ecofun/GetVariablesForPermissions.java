...
public class GetVariablesForPermissions extends Application {
    ...
    public void getVariablesForPermission(final Context context, SharedPreferences sharedPreferences){

        sharedPreferencesV = sharedPreferences;
        mContext = context;
        ...
        user.fetchInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject object, ParseException e) {
                if (e == null){
                    ...
                    sharedPreferencesV.edit().putString("presentUserContinent", presentUserContinent).apply();
                    sharedPreferencesV.edit().putString("userLevel", userLevel).apply();
    ...
    private void getVariablesFromDevice() {

        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(mContext);
        displayingLayoutDate = new Date(System.currentTimeMillis());
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    if (mLastLocation != null) {
                        getContinent(mLastLocation);
                    }else {
                        Log.i("LastKnownLocation", "null");
                    }
                } else {
        ...
        parseUser.fetchInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject object, ParseException e) {
                if (e == null) {
                    ...
                    saveDataToParse(userContinent, userLevelParse, mContext);
                } else {
    ...
    private void saveDataToParse(String userContinentSaved, String userLevelParseSaved, Context mContext) {

        sharedPreferencesV.edit().putString("presentUserContinent", userContinentSaved).apply();
        sharedPreferencesV.edit().putString("userLevel", userLevelParseSaved).apply();
